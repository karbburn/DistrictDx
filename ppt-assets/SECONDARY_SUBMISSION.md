...
The GitHub repository contains the complete implementation, preprocessing pipeline, validation methodology, and documentation. The interactive dashboard enables exploration of district-level pharmaceutical market attractiveness across all 785 Indian districts.

---

*DistrictDx - District-Level Pharmaceutical Market Attractiveness Index*
*Trilytics 2026 · Sun Pharmaceutical Industries × IIM Calcutta PGDBA Conclave*

*Prepared by Sourabh Pradhan*